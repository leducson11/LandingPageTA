  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <textarea
        ...
        className={
          "w-full resize-y rounded-[10px] border bg-white px-3.5 py-2.5 text-[15px] text-[var(--color-ink,#000)] outline-none transition-colors placeholder:text-[var(--color-ink-muted,#8a8a8d)] focus:border-[var(--color-scholar-indigo,#2c3481)] focus:ring-2 focus:ring-[var(--color-indigo-tint,#e1e4f5)] " +
