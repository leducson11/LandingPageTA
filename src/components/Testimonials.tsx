...
const testimonials = [
  {
    ...
    text: 'Mình từng tự học 6 tháng mà Writing vẫn 5.5. Lên HuyWay được giáo viên chữa từng câu, chỉ ra lỗi sai cụ thể. 3 tháng sau mình thi được 7.5, không tưởng tượng nổi!',
  },
  {
    name: 'Trần Quốc Bảo',
  ...
  },
  {
    ...
    text: 'Mình mất gốc tiếng Anh, rất tự ti. Lộ trình Foundation của HuyWay giúp mình xây nền lại từ đầu. Giáo viên kèm 1-1 rất kiên nhẫn. Thi lần đầu đã 6.5!',
  },
  {
    name: 'Phạm Minh Đức',
  ...
  },
  {
    ...
    text: 'Điều mình thích nhất là dashboard tiến độ, biết mình đang ở band nào, cần cải thiện gì. Không học mò như trước nữa. Cảm ơn HuyWay rất nhiều!',
  },
  {
    name: 'Hoàng Anh Tuấn',
      ...
      <div className="max-w-7xl mx-auto container-px">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <h2 className="mt-5 text-3xl sm:text-4xl font-extrabold text-ink-900 tracking-tight text-balance">
            Học viên HuyWay nói gì?
          </h2>
          <p className="mt-4 text-ink-600 text-lg">
            Hàng nghìn học viên đã thay đổi quỹ đạo tiếng Anh cùng HuyWay. Dưới đây là một vài câu chuyện thật.
          </p>
        </div>
            ...
            <figure key={t.name} className="bg-white rounded-2xl p-6 ring-1 ring-ink-100 hover:shadow-xl hover:-translate-y-1 transition-all flex flex-col">
              ...
              <figcaption className="mt-5 flex items-center gap-3 pt-4 border-t border-ink-100">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-ink-500">{t.duration} học tại HuyWay</p>
                </div>
