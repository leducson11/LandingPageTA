...
const faqs = [
  {
    ...
    a: 'Hoàn toàn được. Lộ trình của Prep có giai đoạn Foundation dành riêng cho người mất gốc hoặc mới bắt đầu. Giáo viên sẽ đánh giá trình độ và thiết kế lộ trình từ ngữ pháp, từ vựng nền tảng trước khi vào kỹ năng IELTS. Rất nhiều học viên của Prep từng bắt đầu từ con số 0 và đạt 6.5 - 7.0+ IELTS.',
  },
  {
    q: 'Chính sách cam kết đầu ra và hoàn tiền thế nào?',
    a: 'Với gói Nâng cao và Combo 1-1, Prep cam kết đầu ra bằng văn bản. Nếu học viên hoàn thành đủ 80% lộ trình, làm đủ bài tập và thi thử nhưng chưa đạt band cam kết, Prep sẽ cho học lại miễn phí. Riêng gói Combo 1-1, nếu chưa đạt mục tiêu, Prep hoàn trả 100% học phí theo điều khoản trong hợp đồng.',
  },
  {
    q: 'Lịch học có linh hoạt không? Tôi đi làm bận có học được không?',
    a: 'Có. Toàn bộ bài giảng được ghi hình sẵn trên nền tảng, bạn có thể học bất cứ lúc nào, ở đâu trên web hoặc app. Lịch kèm 1-1 với giáo viên được linh hoạt sắp xếp theo giờ bạn rảnh, kể cả buổi tối hoặc cuối tuần. Học viên đi làm chiếm hơn 40% cộng đồng Prep.',
  },
  {
    q: 'Học online chất lượng có bằng học ở trung tâm không?',
    a: 'Học online tại Prep được thiết kế để tối ưu hơn học tại trung tâm: bạn được AI chấm chữa bài tức thì, luyện Speaking không giới hạn, xem lại bài giảng bao nhiêu lần tùy thích. Giáo viên vẫn đồng hành 1-1 qua video call. Nhiều học viên phản hồi học online giúp họ tập trung và chủ động hơn.',
  },
  {
      ...
      <div className="max-w-3xl mx-auto container-px">
        <div className="text-center">
          ...
          <p className="mt-4 text-ink-600 text-lg">
            Những câu hỏi Prep được hỏi nhiều nhất — nếu chưa đủ, đội ngũ tư vấn luôn sẵn sàng giải đáp.
          </p>
        </div>
